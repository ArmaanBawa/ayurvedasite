...
const Treatments: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <head></head>
        <title>Treatments | Ayuva Ayurveda</title>
        <meta name="description" content="Explore our comprehensive range of Ayurvedic treatments for chronic diseases and holistic wellness." />
      </Helmet>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Explore our comprehensive range of Ayurvedic treatments, each designed to address 
                specific health conditions through natural healing methods.
              </p>
            </motion.div>
