...
const Diabetes: React.FC = () => {
  return (
    <>
      <Helmet>
        <head></head>
        <title>Diabetes Treatment | Ayuva Ayurveda</title>
        <meta name="description" content="Natural Ayurvedic solutions for managing diabetes and improving metabolic health." />
      </Helmet>
