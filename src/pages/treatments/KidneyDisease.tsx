...
const KidneyDisease: React.FC = () => {
  return (
    <>
      <Helmet>
        <head></head>
        <title>Kidney Disease Treatment | Ayuva Ayurveda</title>
        <meta name="description" content="Natural Ayurvedic solutions for managing kidney disease and improving renal health." />
      </Helmet>
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-emerald-100 mb-8">
                Natural Ayurvedic solutions for managing kidney disease and improving renal health
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="bg-white rounded-xl shadow-md p-8 mb-8">
                <h2 className="text-3xl font-bold text-gray-800 mb-6">Understanding Kidney Disease</h2>
                <p className="text-gray-600 mb-6">
                  Kidney disease is a condition where the kidneys lose their ability to filter waste and excess 
                  fluids from the blood. In Ayurveda, kidney disease is primarily related to an imbalance in 
                  Vata and Pitta doshas, affecting the body's natural filtration system.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-8 mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-emerald-50 p-6 rounded-xl">
                    ...
                    <p className="text-gray-600">Natural herbs and formulations to support kidney function</p>
                  </div>
                  <div className="bg-emerald-50 p-6 rounded-xl">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-3 text-gray-600">
                      <li>• Punarnava (Boerhavia diffusa) formulations</li>
                      <li>• Gokshura (Tribulus terrestris) preparations</li>
                      <li>• Varuna (Crataeva nurvala) combinations</li>
